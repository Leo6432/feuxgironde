...
function fermerTrous(valeurs, largeur, hauteur, r, atelier) {
  ...
  // Une cellule réellement détectée ne doit jamais disparaître : l'érosion
  // ronge les bords de la dilatation, y compris là où il y avait du vrai.
  for (let n = 0; n < valeurs.length; n++) if (valeurs[n] > sortie[n]) sortie[n] = valeurs[n];
  return sortie;
}
