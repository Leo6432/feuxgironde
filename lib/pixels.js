...
// Pas de grille au sol, en mètres.
const PAS_M = 40;

// Garde-fou mémoire : au-delà, on refuse d'allouer la grille plutôt que de
// faire tomber la fonction sur un dépassement mémoire.
const MAX_CELLULES_GRILLE = 40e6;
...
function creerGrille(i0, j0, hauteur, largeur) {
  ...
  return { i0, j0, hauteur, largeur, valeurs: new Float64Array(total) };
}
