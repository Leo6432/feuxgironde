...
// Les deux derniers crans ne servent qu'en dernier recours : à 640 m et plus,
// une cellule dépasse largement le pixel du capteur et la carte devient
// grossière. Ils existent parce que l'alternative est pire — au-delà de ce que
// la fonction peut renvoyer, la carte ne s'affiche pas du tout.
const PAS_M_LADDER = [20, 40, 80, 160, 320, 640, 1280];
