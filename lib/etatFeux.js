...
// une limite de leur service, pas un choix. La barre temporelle couvre
// néanmoins 14 jours, parce que chaque état calculé est archivé (voir
// enregistrerEtat) : les crans qui sortent de la fenêtre FIRMS restent
// consultables grâce à cette archive, tant qu'ils ont été calculés avant de
// sortir. Sans archive pour un cran trop ancien, la réponse le dit
// explicitement plutôt que d'afficher une carte vide comme si rien n'avait
// brûlé.
