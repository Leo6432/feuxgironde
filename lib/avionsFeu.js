...
//     indicatif dédié.
//   — « TRACTC » : vu par l'utilisateur sur flamap, avec la même réserve que
//     PELICAN à l'origine — type d'appareil non confirmé (pourrait être lié
//     aux anciens Tracker S-2F3T, mais leur retrait de flotte n'a jamais été
//     vérifié ici), gardé par précaution sur la foi de sa présence sur le
//     site de référence, à confirmer ou retirer au prochain avis.
//
...
const PATRONS = [/^SECU/, /^MILAN/, /^MORA/, /^PELICAN/, /^FZB/, /^TRACTC/];
