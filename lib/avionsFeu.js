...
// transpondeur. C'est un filtrage BEST-EFFORT, revu deux fois sur preuve :
...
//     référence — un Dash 8 Q400 (immatriculation F-ZBMK) affichait
...
//     générale de la sécurité civile (confirmé : F-ZBMK ci-dessus), en repli
//     si un avion diffuse son immatriculation plutôt qu'un indicatif dédié.
// L'hélicoptère vu en même temps que le Dash 8 reste non identifié — son
// indicatif n'a pas été relevé. Si le relevé suivant (voir
// estIndicatifInsolite) ou un nouvel avis fait ressortir d'autres candidats,
// PATRONS est l'endroit à corriger — un seul tableau.
const PATRONS = [/^SECU/, /^MILAN/, /^PELICAN/, /^FZB/];
