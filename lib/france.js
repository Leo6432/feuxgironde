...
// La première renvoie directement la géométrie de la France ; la seconde
// est un fichier "tous pays" dont il faut extraire la bonne entrée.
const CANDIDATS = [
  {
    url: 'https://raw.githubusercontent.com/johan/world.geo.json/master/countries/FRA.geo.json',
    extraire(json) {
      const g = json.type === 'Feature' ? json.geometry : json;
